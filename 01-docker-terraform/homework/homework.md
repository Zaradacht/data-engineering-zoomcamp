...
```$ sudo docker run --help | grep Automatically```
...
JOIN zones zo ON gtd."PULocationID" = zo."LocationID"
WHERE 
zo."Borough" != 'Unknown'
AND lpep_pickup_datetime::date = '2019-09-18'
GROUP BY zo."Borough", lpep_pickup_datetime::date
...
SELECT
zo."Zone" 
,MAX(i."tip_amount") AS sum_tip
FROM initial i 
JOIN zones zo
ON i."DOLocationID" = zo."LocationID"
GROUP BY zo."Zone"
ORDER BY sum_tip DESC LIMIT 1
),
table3 AS (
SELECT *
FROM table2
